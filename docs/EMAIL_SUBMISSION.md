...
method is dasymetric throughout: everything we know about this village's crops we know only in
aggregate — the Round 1 crop-area shares at village level, the yield anchor at district level — and
the SAR supplies only the variation inside each aggregate. Concretely, crop
